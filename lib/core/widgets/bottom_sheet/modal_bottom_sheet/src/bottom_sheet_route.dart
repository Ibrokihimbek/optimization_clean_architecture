...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  String _getRouteLabel() {
    ...
    switch (platform) {
      ...
      case TargetPlatform.fuchsia:
        if (Localizations.of<dynamic>(context, MaterialLocalizations) != null) {
  ...
  Widget build(BuildContext context) {
    ...
    assert(
      widget.route._animationController != null,
      "No animation controller found.",
    );
      ...
      child: Builder(
        builder: (BuildContext context) => AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            assert(child != null, "No child found.");
            ...
            return Semantics(
              ...
              child: ModalBottomSheet(
                ...
                shouldClose: widget.route._hasScopedWillPopCallback
                    ? () async {
                        final RoutePopDisposition willPop =
...
Future<T?> showCustomModalBottomSheet<T>({
  ...
  assert(
    ...
    "No MaterialLocalizations widget found.",
  );
